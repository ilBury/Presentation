		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Products",
									"targetURL": "#presapppresentationapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"presapppresentationapp-display": {
								"semanticObject": "presapppresentationapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pres.app.presentationapp",
									"url": sap.ui.require.toUrl("pres/app/presentationapp")
								}
							}
						}
					}
